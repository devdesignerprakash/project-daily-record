...
export default function FitnessTab({ records, onSuccess, onError }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await api.put(`/api/fitness/${editingId}`, form);
        onSuccess("सवारी फिटनेस डाटा सफलतापूर्वक सम्पादन भयो!");
      } else {
        await api.post("/api/fitness", form);
      ...
      <Card className="lg:col-span-1 border border-slate-200 dark:border-zinc-800 shadow-sm">
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="fit-nabikaran" className="text-xs font-semibold">
            ...
            <div className="space-y-2">
              <Label htmlFor="fit-pratilipi" className="text-xs font-semibold">
