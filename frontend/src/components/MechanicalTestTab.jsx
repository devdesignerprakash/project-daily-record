...
import { PlusCircle, Calendar, Wrench } from "lucide-react";
      ...
      <Card className="lg:col-span-1 border border-slate-200 dark:border-zinc-800 shadow-sm">
        <CardHeader>
          ...
          <CardDescription className="text-xs">
            दैनिक यान्त्रिक परीक्षण संख्या दर्ता गर्नुहोस्
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter>
            <Button
              type="submit"
              className="w-full bg-orange-700 hover:bg-orange-600 text-white rounded-md text-sm"
            >
