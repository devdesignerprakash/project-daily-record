...
class RoutePermitService {
  static async createRoutePermitData(data) {
    try {
      ...
      logger.error("Error creating routePermit data:", error);
      throw error;
    }
  }
  ...
  static async updateRoutePermitData(id, data) {
    try {
      ...
      logger.error("Error updating routePermit data:", error);
      throw error;
    }
  }
  ...
  static async getRoutePermitDataByDateRange(startDateString, endDateString) {
    try {
      ...
      logger.error("Error fetching routePermit data by date range:", error);
      throw error;
    }
  }
  ...
  static async getRoutePermitDataByTimeRange(startTime, endTime) {
    try {
      ...
      logger.error("Error fetching routePermit data by time range:", error);
      throw error;
    }
  }
  ...
  static async getRoutePermitDataByDate(dateString) {
    try {
      ...
      logger.error("Error fetching routePermit data by date:", error);
      throw error;
    }
  }
}
